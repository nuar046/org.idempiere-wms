...
{	
	...
	protected String doIt () throws Exception
	{
		...
		String whereClause = "EXISTS (SELECT T_Selection_ID FROM T_Selection WHERE  T_Selection.AD_PInstance_ID=? AND T_Selection.T_Selection_ID=WM_InOutBoundLine.WM_InOutbound_ID)";		
	...
	{				
		...
		{	
			...
			{	
				throw new AdempiereException("Transit Warehouse does not exist");
			}
