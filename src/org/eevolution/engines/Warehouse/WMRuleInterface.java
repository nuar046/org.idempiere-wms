...
public interface WMRuleInterface 
{
	...
	public abstract Collection<MStorageOnHand> getStorage(Properties ctx, int M_Warehouse_ID , int M_Product_ID, int M_AttributeSetInstance_ID, BigDecimal qtyToDelivery, int WM_Area_Type_ID , int WM_Section_Type_ID, String trxName);				
}
